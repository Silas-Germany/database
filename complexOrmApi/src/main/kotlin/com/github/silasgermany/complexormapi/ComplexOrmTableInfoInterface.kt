...
interface ComplexOrmTableInfoInterface {
    val normalColumns: SortedMap<String, SortedMap<String, String>>
    val connectedColumns: SortedMap<String, SortedMap<String, String>>
    val joinColumns: SortedMap<String, SortedMap<String, String>>
    val reverseJoinColumns: SortedMap<String, SortedMap<String, String>>
    val reverseConnectedColumns: SortedMap<String, SortedMap<String, String>>
    val specialConnectedColumns: SortedMap<String, SortedMap<String, String>>
